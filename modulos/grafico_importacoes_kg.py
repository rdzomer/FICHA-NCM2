# grafico_importacoes_kg.py (refatorado)
...
def gerar_grafico_importacoes(df, ncm_formatado, last_updated_month, last_updated_year):
    """
    Gera o gráfico de importações, usando a função base e formatando o eixo Y.
    """
    fig = _gerar_grafico_base(df, 'Importações', ncm_formatado, last_updated_month, last_updated_year)

    # Formatação do Eixo Y (específica para importações)
