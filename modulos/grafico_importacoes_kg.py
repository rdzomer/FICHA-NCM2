# modulos/grafico_importacoes_kg.py (COMPLETO)
...
def gerar_grafico_importacoes(df, df_2024_parcial, ncm_formatado, last_updated_month, last_updated_year):
    ...
    return _gerar_grafico_base(df, df_2024_parcial, 'Importações', ncm_formatado, last_updated_month, last_updated_year, tipo_valor='KG')
